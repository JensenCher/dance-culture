...
type Category = (typeof DANCE_CATEGORIES)[number];
                ...
                <div className="col-span-4 col-start-1 grid grid-cols-3 gap-x-8">
                  {category.featured.map((item) => (
                    <div key={item.name} className="group relative text-base sm:text-sm">
                      <div className="relative aspect-video overflow-hidden roudned-lg bg-gray-100 group-hover:opacity-75 duration-200">
                        <Image src={item.imageSrc} alt="produyct category image" fill className="object-cover object-center" />
                      </div>
