    ...
    return (
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="text-muted-foreground text-sm text-center">
          This token is not valid or might be expired. <span>Please try again.</span>
        </p>
      </div>
    );
  }
  ...
  if (data?.success) {
    return (
      <div className="flex h-full flex-col items-center justify-center">
        ...
        <p className="text-sm text-muted-foreground mt-1">Thank you for verifying your email.</p>
